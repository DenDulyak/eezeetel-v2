...
<%
	...
	String strQuery = "update t_master_users set User_Active_Status = 1"
						+ ", User_Modified_Time = now()"
						+ " where User_Login_ID = '" + record_id + "'" 
						+ " and User_Active_Status = 0 "
	...
	{
		String strError = "<HTML><BODY><H4><FONT COLOR=\"RED\">Failed to Activate User.</FONT></H4>" + 
