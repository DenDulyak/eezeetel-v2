...
<%
    ...
    if (dbHelper.GetCustomerGroupID(nCustomerId) == nCustomerGroupID) {
        ...
        if (dbHelper.executeQuery(strQuery))
            response.sendRedirect(ksContext + "/admin/Accounts/ManageCustomerCredit.jsp");
        else {
            String strError = "<HTML><BODY><H4><FONT COLOR=\"RED\">Failed to Add Customer Credit.</FONT></H4>" +
                    "<A HREF=\"" + ksContext + "/admin/Accounts/ManageCustomerCredit.jsp\">Manage Customer Credit</A></BODY></HTML>";
