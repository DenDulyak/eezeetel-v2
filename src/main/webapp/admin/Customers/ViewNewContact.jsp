...
<head>
    ...
    <script language="javascript">
        function validate_and_submit(status) {
            ...
            document.the_form.action = "/admin/Customers/UpdateNewContactInfo.jsp?status=" + status;
...
<form name="the_form" action="" method="post">
    ...
    <table border="1" width="50%">
        <%
            ...
            String strQuery = "from TNewContacts where Sequence_ID = " + strNewContactID + " and Group_ID = " + nCustomerGroupID;
        ...
        <tr>
            ...
            <td><select name="addressed_by">
                <%
                    strQuery = "from User where (User_Type_And_Privilege = 4 OR User_Type_And_Privilege = 5) and User_Active_Status = 1 and Customer_Group_ID = " + nCustomerGroupID;
