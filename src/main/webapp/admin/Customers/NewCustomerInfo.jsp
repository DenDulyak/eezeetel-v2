    ...
    <script language="javascript">
        function ValidateInput() {
            ...
            if (errString == null || errString.length <= 0) {
                ...
                document.the_form.action = "/admin/Customers/AddCustomerInfo.jsp";
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td align="left">
                ...
                <input type="hidden" name="Customer_Group_ID" value="<%=nCustomerGroupID%>">
            </td>
        </tr>
        <tr>
            <td align="right">
                ...
                <c:forEach items="${features}" var="feature">
                    <label>
                        <input type="checkbox" name="${feature.featureType}"
                                <c:if test="${feature.featureType != 'BULK_UPLOAD' && feature.featureType != 'CREDIT_LIMIT'}"> checked </c:if>
                                />${feature.title}
                    </label>
                </c:forEach>
            </td>
        ...
        <tr>
            ...
            <td align="left">
                <input type="checkbox" name="allow_credit" checked>
            </td>
        </tr>
