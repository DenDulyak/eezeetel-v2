...
<%
    ...
    // String strAddtionalNotes = request.getParameter("additional_notes");
    ...
    try {
        ...
        response.sendRedirect("ManageCustomerCredit.jsp");
    } catch (Exception e) {
        theSession.getTransaction().rollback();
        String strError = "<HTML><BODY><H4><FONT COLOR=\"RED\">Failed to Update Customer Credit.</FONT></H4>" +
                "<A HREF=\"ManageCustomerCredit.jsp\">Manage Customer Credit</A></BODY></HTML>";
