...
<%
    ...
    String strQuery = "from TMasterCustomerGroupCredit where Group_Credit_ID = " + nCreditID;
    ...
    try {
        ...
        if (records.size() > 0) {
            TMasterCustomerGroupCredit custGroupCredit = (TMasterCustomerGroupCredit) records.get(0);
            TMasterCustomerGroups groupInfo = (TMasterCustomerGroups) custGroupCredit.getGroup();
            String userCollected = custGroupCredit.getCollectedBy().getUserFirstName();
            nCustomerGroupID = groupInfo.getId();
            strCompanyName = groupInfo.getName();
            nPaymentType = custGroupCredit.getPaymentType();
            strPaymentDetails = custGroupCredit.getPaymentDetails();
            fPaymentAmount = custGroupCredit.getPaymentAmount();
            nCreditOrDebit = custGroupCredit.getCreditOrDebit();
            Date dtPaymentDate = custGroupCredit.getPaymentDate();
...
<head>
    ...
    <script language="javascript">
        ...
        function ValidateInput() {
            ...
            if (document.the_form.payment_amount.value > 10000)
                errString += "\r\nPayment amount can not be more than 10000.";
        ...
        function UpdateRecord() {
            ...
            document.the_form.action = "UpdateCustomerGroupCredit.jsp";
