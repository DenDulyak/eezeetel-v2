...
<head>
    ...
    <script language="javascript">
        ...
        function AddOnly() {
            ...
            document.the_form.action = "AddCustomerGroupCredit.jsp";
            document.the_form.submit();
        }

        function AddAndAdjust() {
            if (!ValidateInput()) return;
            document.the_form.action = "AddAndAdjustCustomerGroupCredit.jsp";
            document.the_form.submit();
        }
                ...
                <select name="customer_group_id">
                    ...
                    <%
                        ...
                        try {
                            ...
                            String strQuery = "from TMasterCustomerGroups where IsActive = 1 and Check_Aganinst_Group_Balance = 1 order by Customer_Group_Name";
