...
<% 
    ...
    String strQuery = "insert into t_master_customer_group_credit (Customer_Group_ID, Payment_Type, Payment_Details, " + 
	...
	if (dbHelper.executeQuery(strQuery))
		response.sendRedirect("ManageCustomerGropupCredit.jsp");
	else
	{
		String strError = "<HTML><BODY><H4><FONT COLOR=\"RED\">Failed to Add Customer Group Credit.</FONT></H4>" + 
