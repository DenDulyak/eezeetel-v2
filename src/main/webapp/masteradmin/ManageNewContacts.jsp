...
<form name="the_form" action="">
    ...
    <table border="1" width="100%">
        ...
        <%
            String strQuery = "from TNewContacts order by Addressed, Contact_Time";
        ...
        <tr bgcolor="<%=strBgColor%>">
            <td align="center">
                <a href="/masteradmin/ViewNewContact.jsp?new_contact_id=<%=newContact.getId()%>"><%=newContact.getId()%>
                </a>
            </td>
