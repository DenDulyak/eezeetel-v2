...
<head>
    ...
    <script language="javascript">
        function initialLoad(customer_id) {
            ...
            var url = "AJAX_GetCreditInfo.jsp?customer_id=" + customer_id;
        ...
        function submit_request(submit_case) {
            ...
            document.the_form.action = "ProcessCreditRequest.jsp?action_case=" + submit_case + "&credit_request_id=" + <%=creditRequest.getId()%>;
