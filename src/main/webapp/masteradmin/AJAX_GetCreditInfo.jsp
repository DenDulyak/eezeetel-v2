...
<%
String strCutoffDate = "'2011-02-28 23:59:59'";
...
try {
	...
	{	
		...
		strQuery = "from TMasterCustomerCredit where Customer_ID = " + 
						custInfo.getId() + " and Entered_Time > '2011-01-01 00:00:00' " +
		...
		for (int i = 0; i < latestTransactions.size(); i++)
		{
			...
			if (custCredit.getCreditOrDebit() == 1)
			{
				...
				{
				case 1:	strLast5Payments += "Cash, "; break;
				case 2:	strLast5Payments += "Cheque, "; break;
				case 3:	strLast5Payments += "Bank, "; break;
				case 4:	strLast5Payments += "Transfer, "; break;
				case 5:	strLast5Payments += "Card, "; break;				
				}
			}
		...
		String strResult = "<table border=\"1\">";	
			...
			strResult += "<tr> <td bgcolor=> Customer Group</td>";
			strResult += "<td>" + custGroup.getName() + "</td></tr>";
